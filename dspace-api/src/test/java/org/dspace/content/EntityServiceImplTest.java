...
public class EntityServiceImplTest  {
    ...
    public void testGetRelationsByTypeName() throws Exception {
        ...
        assertEquals(relationshipList,
                entityService.getRelationsByTypeName(context, "leftwardType"), "TestGetRelationsByLabel 0");
    }
    ...
    public void testGetAllRelationshipTypes() throws Exception {
        ...
        assertEquals(relationshipTypeList,
                entityService.getAllRelationshipTypes(context, entity), "TestGetAllRelationshipTypes 0");
    }
    ...
    public void testGetLeftRelationshipTypes() throws Exception {
        ...
        assertEquals(relationshipTypeList,
                entityService.getLeftRelationshipTypes(context, entity), "TestGetLeftRelationshipTypes 0");
    }
    ...
    public void testGetRightRelationshipTypes() throws Exception {
        ...
        assertEquals(relationshipTypeList,
                entityService.getRightRelationshipTypes(context, entity), "TestGetRightRelationshipTypes 0");
    }
