...
public class BitstreamRestRepositoryIT extends AbstractControllerIntegrationTest {
    ...
    public void deleteBitstreamsInBulk() throws Exception {
        ...
        assertTrue(bitstreamExists(token, bitstream1, bitstream2, bitstream3, bitstream4));
        ...
        assertTrue(bitstreamNotFound(token, bitstream1, bitstream2, bitstream3));
        assertTrue(bitstreamExists(token, bitstream4));
    }
